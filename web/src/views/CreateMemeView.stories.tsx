...
export const GenerateAndMint: Story = {
  ...
  play: async ({ canvasElement, loaded }) => {
    ...
    await userEvent.type(canvas.getByRole('textbox', { name: copy.generate.promptLabel }), 'a cat on the moon')
...
export const GenerationFailure: Story = {
  ...
  play: async ({ canvasElement }) => {
    const canvas = within(canvasElement)
    await userEvent.type(canvas.getByRole('textbox', { name: copy.generate.promptLabel }), 'fail')
    await userEvent.click(canvas.getByRole('button', { name: copy.generate.renderImage }))
