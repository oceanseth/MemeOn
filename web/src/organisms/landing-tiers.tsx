...
export type LandingTiersProps = Pick<
  LandingScreenModel,
  'tiersTitle' | 'tiers' | 'frameImageProps' | 'frameSlotProps'
>

/** Virality ladder: one foil card per tier, slot reserved in loading / ready / error. */
