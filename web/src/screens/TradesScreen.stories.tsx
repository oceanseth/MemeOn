...
const memeNames: TradeMemeInfoMap = {
  [paperMeme.id]: { title: paperMeme.title, imageUrl: paperMeme.imageUrl, tierKey: 'paper', tierLabel: 'Paper · common', tierColor: '#9aa4bf', reshares: 0 },
  [silverMeme.id]: { title: silverMeme.title, imageUrl: silverMeme.imageUrl, tierKey: 'silver', tierLabel: 'Silver · uncommon', tierColor: '#c9d2e4', reshares: 12 },
}
...
export const Ready: Story = {
  args: { phase: 'ready', open: [openTrade], history: [pastTrade] },
...
export const Proposed: Story = {
  args: { phase: 'ready', msg: 'Trade proposed. It is on their table now.', open: [openTrade], history: [pastTrade] },
  play: async ({ canvasElement }) => {
