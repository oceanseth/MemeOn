...
export const Error: Story = {
  args: {
    ...
    showEmpty: false,
    showError: true,
    resultsLabel: copy.results.errored,
  },
...
export const LoadMoreFailed: Story = {
  args: {
    ...ready,
    showMore: true,
    loadMoreLabel: copy.loadMoreRetry,
...
export const FiltersNarrowed: Story = {
  args: {
    ...
    resultsLabel: copy.results.line([
      copy.results.count(2),
      copy.filters.media.images,
      'Holo',
      copy.results.activeListed,
    ]),
  ...
  play: async ({ canvasElement, args }) => {
    ...
    await expect(well.querySelector('[data-slot="input-group-control"]')).toHaveAttribute(
      'type',
      'search',
    )
...
export const FilterTabsPressAndToggle: Story = {
  ...
  play: async ({ canvasElement }) => {
    ...
    await expect(
      media.getByRole('button', { name: copy.filters.media.videos }).getBoundingClientRect().height,
    ).toBe(46)
  },
}
