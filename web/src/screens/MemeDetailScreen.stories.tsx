...
export const Copied: Story = {
  args: { detail: { ...detail(), copyDone: true, copyButtonLabel: copy.share.copied } },
  play: async ({ canvasElement }) => {
    const canvas = within(canvasElement)
