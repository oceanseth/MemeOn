 ...
 * dragging `molecules/meme-card.tsx` and `react-router-dom`'s `Link` onto its critical path.
 * `molecules/meme-card.tsx`, `screens/LandingScreen.tsx` and `hooks/useCreateMemeScreen.ts` all import
