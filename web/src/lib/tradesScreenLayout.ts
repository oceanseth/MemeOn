...
export const composeLegend = 'mb-2.5 text-intro font-semibold tracking-normal text-ink normal-case'
...
export const listHeading = 'm-0 font-display text-title font-medium tracking-title text-ink'

export const headingRow = 'mb-3.5 flex flex-wrap items-baseline gap-x-3 gap-y-1'

export const countNote = 'text-small text-ink-muted tabular-nums'

export const composerIntro = 'm-0 mt-1.5 text-small font-medium text-ink-muted'

export const proposeRow = 'flex flex-wrap items-center justify-between gap-x-6 gap-y-3.5'

export const proposeCaption = 'text-small text-ink-muted'
