...
import * as S from "@ds-stories/ui/src/ConfirmDialog.stories";
...
export const Default = /* Default */ stage(compose(S, "Default"), 460);
export const Danger = /* Danger */ stage(compose(S, "Danger"), 460);
export const Busy = /* Busy */ stage(compose(S, "Busy"), 460);
export const RichMessage = /* Rich Message */ stage(compose(S, "RichMessage"), 460);
export const Closed = /* Closed */ stage(compose(S, "Closed"), 460);
